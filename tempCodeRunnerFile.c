...
int main(){
    ...
    float productEvenNumbers(float num001, float num002, float num003){
            ...
            float evenpercent=33.00;
            return("El promedio de los numeros ingresados es de %.2f y el porcentaje de numeros pares ingresados es de %.2f %", prom, evenpercent);
    }         
    ...
    float sumSquaresOddNumbers(float num001, float num002, float num003){
            ...
            int oddsquare003=0;
            if(num1%2 != 0){
                int oddsquare001 = num1*num1;
            }
            if(num2%2 != 0){
                int oddsquare002 = num2*num2;
            }
            if(num3%2 != 0){
                int oddsquare003 = num3*num3;
            }
            else{
                printf("");
            }
            int oddsquaresum=oddsquare001+oddsquare002+oddsquare003;
            return("La suma de los cuadrados de aquellos que sean impares es de %i", oddsquaresum);
    }
